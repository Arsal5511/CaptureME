...
const products = [
  ...
  { name: 'Event Photography', description: 'Speak directly to your customers', href: '/', icon: CursorArrowRaysIcon },
  { name: 'Promotional Video Production', description: 'Your customers’ data will be safe and secure', href: '/', icon: FingerPrintIcon },
  { name: 'Cooperative Photography', description: 'Connect with third-party tools', href: '/', icon: SquaresPlusIcon },
  { name: 'Food Photography', description: 'Build strategic funnels that will convert', href: '/', icon: ArrowPathIcon },
]
const callsToAction = [
